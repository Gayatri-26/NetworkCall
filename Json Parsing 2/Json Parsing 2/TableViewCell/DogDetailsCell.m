...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        NSLayoutConstraint *leftbreed = [NSLayoutConstraint constraintWithItem:_breed attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeLeft multiplier:1 constant:20];
        ...
        NSLayoutConstraint *lefthighclass = [NSLayoutConstraint constraintWithItem:_highclass attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeLeft multiplier:1 constant:20];
        ...
        NSLayoutConstraint *leftlifespam = [NSLayoutConstraint constraintWithItem:_lifespam attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeLeft multiplier:1 constant:20];
